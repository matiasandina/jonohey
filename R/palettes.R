...
.jonohey_palettes <- list(
  ...
  dark = c(red = "#d03a22ff", turquoise ="#187376ff", gray = "#727061ff", green = "#257d26ff",
           purple = "#a039a6ff", cement = "#64676cff", blue = "#1f55b5ff", brown = "#a05917ff",
           lightblue = "#ccf0ffff"),
  ...
  light = c(red = "#fd6041ff", turquoise = "#44b7beff", gray = "#97957eff", green = "#45b046ff",
            purple = "#cb64d1ff", cement = "#878b94ff", blue = "#5489d5ff", brown = "#f2922cff",
            lightblue = "#fcf7daff"),
